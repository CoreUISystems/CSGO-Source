...
namespace LufzyCSharpMemory
{
    class LufzyCSharpMemory
    {
        ...
        #region ProcessControlUnit
        internal static void OpenProcess(int pId, ProcessAccessFlags ProcessAccess = ProcessAccessFlags.All)
        {
            ProcessHandle = Methods.OpenProcess(ProcessAccess, false, pId);
        }
        internal static int AllocateMemory(int memorySize)
        {
            return (int)Methods.VirtualAllocEx(ProcessHandle, (IntPtr)0, (IntPtr)memorySize, 0x1000, 0x40);
            //Ur Mom Gay
        }
        internal static IntPtr CreateRemoteThread(int address)
        {
            return Methods.CreateRemoteThread(ProcessHandle, (IntPtr)0, (IntPtr)0, (IntPtr)address, (IntPtr)0, 0, (IntPtr)0);
        }
        internal static void WaitForSingleObject(IntPtr threadHandle)
        {
            if (Methods.WaitForSingleObject(threadHandle, INFINITE) != WAIT_OBJECT_0)
            {
        ...
        {
            bool result;
            result = Methods.VirtualFreeEx(ProcessHandle, (IntPtr)address, (IntPtr)0, FreeType.Release);
        }
        internal static void CloseProcess(IntPtr handle)
        {
            Int32 result = Methods.CloseHandle(handle);
        }
        #endregion

        #region Writes Memory
        internal static void WriteBoolean(int Address, bool Value)
        {
            UInt32 nBytesRead = 0;
            byte[] bArray = BitConverter.GetBytes(Value);
            bool flag = Methods.WriteProcessMemory(ProcessHandle, (IntPtr)Address, bArray, (IntPtr)2, ref nBytesRead);
        }
        internal static void WriteBytes(int address, byte[] value)
        {
            bool success;
            UInt32 nBytesRead = 0;
            success = Methods.WriteProcessMemory(ProcessHandle, (IntPtr)address, value, (IntPtr)value.Length, ref nBytesRead);
        }
        internal static void WriteStruct(int address, object value)
        {
            ...
            UInt32 nBytesRead = 0;
            success = Methods.WriteProcessMemory(ProcessHandle, (IntPtr)address, buffer, (IntPtr)buffer.Length, ref nBytesRead);
        }
        internal static void WriteInt(int address, int value)
        {
            ...
            UInt32 nBytesRead = 0;
            success = Methods.WriteProcessMemory(ProcessHandle, (IntPtr)address, buffer, (IntPtr)4, ref nBytesRead);
        }
        ...
        internal static void WriteShort(int address, short value)
        {
            ...
            byte[] buffer = BitConverter.GetBytes(value);
            UInt32 nBytesRead = 0;
            success = Methods.WriteProcessMemory(ProcessHandle, (IntPtr)address, buffer, (IntPtr)2, ref nBytesRead);
        }
        internal static void WriteByte(int address, byte value)
        {
            ...
            byte[] buffer = BitConverter.GetBytes(value);
            UInt32 nBytesRead = 0;
            success = Methods.WriteProcessMemory(ProcessHandle, (IntPtr)address, buffer, (IntPtr)1, ref nBytesRead);
        }
        #endregion
        ...
        internal static bool ReadBool(int Address)
        {
            ...
            UInt32 intPtr1 = 0;
            Methods.ReadProcessMemory(ProcessHandle, (IntPtr)Address, bArray, 2, ref intPtr1);
        ...
        internal static byte[] ReadBytes(int address, int size)
        {
            ...
            UInt32 nBytesRead = 0;
            success = Methods.ReadProcessMemory(ProcessHandle, (IntPtr)address, buffer, (uint)size, ref nBytesRead);
            return buffer;
        }
        internal static int ReadInt(int address)
        {
            ...
            UInt32 nBytesRead = 0;
            success = Methods.ReadProcessMemory(ProcessHandle, (IntPtr)address, buffer, 4, ref nBytesRead);
        ...
        internal static string ReadUnicode(uint address, uint maxSize, ref uint _bytesRead)
        {
            ...
            UInt32 nBytesRead = 0;
            success = Methods.ReadProcessMemory(ProcessHandle, (IntPtr)address, buffer, maxSize, ref nBytesRead);
        ...
        internal static object ReadStruct(int address, Type anyType)
        {
            ...
            UInt32 nBytesRead = 0;
            success = Methods.ReadProcessMemory(ProcessHandle, (IntPtr)address, buffer, (UInt32)rawsize, ref nBytesRead);
